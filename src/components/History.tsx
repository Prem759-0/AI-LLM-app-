    ...
    <div className="flex flex-col h-full w-full max-w-6xl mx-auto px-4 md:px-8 py-8 overflow-y-auto no-scrollbar">
          ...
          {isSelectionMode ? (
            <>
              ...
              <Button 
                ...
                className="bg-red-500 hover:bg-red-600 text-white rounded-xl px-6 h-12 font-bold shadow-lg shadow-red-500/20 gap-2"
              >
                <Trash2 size={18} />
            ...
            <Button 
              ...
              className="rounded-xl border-slate-200 text-slate-600 font-bold h-12 px-6"
            >
              Select Chats
            </Button>
          )}
      ...
      {loading ? (
        <div className="flex flex-col items-center justify-center py-32 space-y-4">
          ...
          <p className="text-slate-400 font-black uppercase tracking-widest text-xs">Loading History...</p>
        </div>
      ) : chats.length === 0 ? (
        <div className="flex flex-col items-center justify-center py-24 text-center space-y-6 glass rounded-[3rem] border-white/50">
          ...
          <div>
            <h3 className="text-2xl font-black text-slate-800">No history found</h3>
        ...
        <div className="grid grid-cols-1 gap-4 mb-12">
          {chats.map((chat, i) => (
            <motion.div
              ...
              className={cn(
                "glass p-6 rounded-[2rem] border-white/50 shadow-sm hover:shadow-xl transition-all flex items-center justify-between group cursor-pointer relative overflow-hidden",
                selectedChats.includes(chat._id) && "ring-2 ring-brand bg-brand/5"
              )}
